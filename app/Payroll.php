...
class Payroll extends Model
{
    ...
    //
    protected $fillable=['month','year','company_id','workflow_id','payslip_issued','for','user_id','approved','disbursed'];
    protected static $logAttributes = ['month','year','company.name','workflow.name','payslip_issued','for','user.name','approved','disbursed'];
