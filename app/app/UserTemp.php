...
//    protected static $logOnlyDirty = true;
    ...
    {
        return $this->belongsTo('App\User','rank_id');
    }
    ...
    {
        return $this->belongsTo('App\FieldOffice','field_office_id');
    }
