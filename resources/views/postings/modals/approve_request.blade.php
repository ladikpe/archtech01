<div class="modal fade in modal-3d-flip-horizontal modal-info" id="approvePostingModal" aria-hidden="true" aria-labelledby="approvePostingModal" role="dialog" tabindex="-1">
	    <div class="modal-dialog ">
	      <form class="form-horizontal" id="approvePostingForm" enctype="multipart/form-data">
          ...
          <input type="hidden" name="type" value="save_posting_approval">
          <input type="hidden" name="posting_approval_id" id="approval_id" >
