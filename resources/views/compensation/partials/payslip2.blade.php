...
<html>
  ...
  <body>
      ...
      <header style="float: left;padding:5px"><img src="{{url('uploads/logo').$company->logo}}" style="height: 2.5rem;background-color:#fff; width: auto;"></header> 
    <div class="cont" >
    ...
    <table>
        ...
        <tr>
            <td style="text-align:left" class="small-font">Employee's Address</td>
            <td style="text-align:right" class="small-font">{{$detail->user->address}}</td>
        </tr>
        <tr>
  ...
  <table class="payslip small-font" style="width:100%;">
    ...
    <tbody>
      <tr>
        ...
        <td>
        Grade:@if($detail->user->grade){{$detail->user->only_grade}}{{$detail->user->only_level?'-'.$detail->user->only_level:''}} @endif
        </td>
        <td>
