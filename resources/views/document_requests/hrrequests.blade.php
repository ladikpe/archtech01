                            ...
                            <div class="table-responsive">
                                <table class="table table striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$document_request->user?$document_request->user->name:""}}</td>
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="exampleIconDropdown1" role="menu">
                                                        ...
                                                        @endif
                                                         @if($document_request->employee_file!='')
                                                          <a style="cursor:pointer;"class="dropdown-item" id="" href="{{url('document_requests/employee_download?document_request_id='.$document_request->id)}}"><i class="fa fa-download" aria-hidden="true"></i>&nbsp;Employee Document</a>
                                                          @endif
                                                        @endif
                                                    </div>
                                                </div>
