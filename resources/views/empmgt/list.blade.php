...
@section('content')
            ...
            <div id="contactsContent" class="page-content page-content-table" data-plugin="asSelectable">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group " data-plugin="formMaterial">
                                                ...
                                                <select class="form-control" name="department" required id="department"onchange="departmentChangeFilter(this.value);">
                                                    @if($departments)
                                       ...
                                       <div class="col-md-4">
                                            <div class="form-group " data-plugin="formMaterial">
                                                <label class="form-control-label" for="name" >Divisions/Units</label>
                                                <select class="form-control" name="division"  id="filter-divisions" style="width: 100%">
                                                    
                                                        <option value="0">Please select department</option>
                                                        @if(request()->division!=0)
                                                            
                                                             @foreach($departments->where('id',request()->department)->first()->divisions as $division)
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group " data-plugin="formMaterial">
                                                <label class="form-control-label" for="name" >Cadre</label>
                                                <select class="form-control select2" name="cadre" required id="cadre" onchange="cadreChangeFilter(this.value);" style="width: 100%">
                                                    @if($cadres)
                                                        <option value="0">All Cadres</option>
                                                        @foreach($cadres as $cadre)
                                                            <option value="{{$cadre->id}}" {{ request()->cadre==$cadre->id?'selected':'' }}>{{$cadre->name}}</option>
                                                        @endforeach
                                                    @else
                                                        <option value="0">No cadre</option>
                                                    @endif
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group " data-plugin="formMaterial">
                                                <label class="form-control-label" for="name" >Rank</label>
                                                <select class="form-control" name="rank"  id="filter-ranks" style="width: 100%">
                                                    
                                                        <option value="0">Please select cadre</option>
                                                        @if(request()->rank!=0)
                                                            
                                                             @foreach($cadres->where('id',request()->cadre)->first()->ranks as $rank)
                                                                <option value="{{$rank->id}}" {{ request()->rank==$rank->id?'selected':'' }}>{{$rank->name}}</option>
                                                             @endforeach
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group " data-plugin="formMaterial">
                                                <label class="form-control-label" for="name" >Zones</label>
                                                <select class="form-control select2" name="zone" required id="zone" onchange="zoneChangeFilter(this.value);" style="width: 100%">
                                                    @if($zones)
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group " data-plugin="formMaterial">
                                                <label class="form-control-label" for="name" >Field Office</label>
                                                <select class="form-control" name="field_office"  id="filter-field_offices" style="width: 100%">
                                                    
                                                        <option value="0">Please select Zone</option>
                                                        @if(request()->field_office!=0)
                                                             @foreach($zones->where('id',request()->zone)->first()->field_offices as $field_office)
                                                                <option value="{{$field_office->id}}" {{ request()->field_office==$field_office->id?'selected':'' }}>{{$field_office->name}}</option>
                                                             @endforeach
                                                        @endif
                                                </select>
                                            </div>
                ...
                <span class="checkbox-custom checkbox-primary checkbox-lg contacts-select-all">
                  ...
                  <label for="select_all"></label>
                            ...
                            <th data-priority="3"  class="cell-300" scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">Division</th>
                            <th data-priority="3"  class="cell-300" scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4"> Cadre </th>
                            <th data-priority="3"  class="cell-300" scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">Rank</th>
                            <th data-priority="3"  class="cell-300" scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4"> Zone </th>
                            <th data-priority="3"  class="cell-300" scope="col" data-tablesaw-sortable-col data-tablesaw-priority="4">Field Office</th>
                ...
                <span class="checkbox-custom checkbox-primary checkbox-lg">
                  ...
                  <label for="contacts_1"></label>
                                ...
                                <td class="cell-300" >{{$user->rank?($user->rank->grade?$user->rank->grade->level:''):''}}</td>
                                <td class="cell-300" >
                                ...
                                <td class="cell-300" >{{$user->department?$user->department->name:''}}</td>
                                <td class="cell-300" >{{$user->division?$user->division->name:''}}</td>
                                 <td class="cell-300" >{{$user->rank?($user->rank->cadre?$user->rank->cadre->name:''):''}}</td>
                                  <td class="cell-300" >{{$user->rank?$user->rank->name:''}}</td>
                                   <td class="cell-300" >{{$user->field_office?($user->field_office->zone?$user->field_office->zone->name:''):''}}</td>
                                  <td class="cell-300" >{{$user->field_office?$user->field_office->name:''}}</td>
                                ...
                                {{--<td >--}}
                              <td class="cell-300" >{{$user->plmanager?$user->plmanager->name:''}}</td>
                                {{--</td>--}}
    ...
    <div class="site-action" data-plugin="actionBtn">
        ...
        <div class="site-action-buttons">
            @if (Auth::user()->role->permissions->contains('constant', 'reset_password'))
                <button type="button" id="resetPassword" class="btn-raised btn btn-success btn-floating animation-slide-bottom" title="Reset Password" >
...
// alert($('#query_content'+$(this).val()).val());
        ...
        $(document).on('click','#resetPassword',function(event){
            ...
            $.get('{{ url('/users/resetpassword') }}/',{ users:users },function(data){
        ...
        function cadreChangeFilter(cadre_id){
            event.preventDefault();
            $.get('{{ url('/users/cadre/ranks') }}/'+cadre_id,function(data){
                if (data.ranks=='') {
                    $("#filter-ranks").empty();
                    $('#filter-ranks').append($('<option>', {value:0, text:'Please Create a Rank in Cadre'}));
                }else{
                    $("#filter-ranks").empty();
                    $('#filter-ranks').append($('<option>', {value:0, text:'Please Select a Rank'}));
                    jQuery.each( data.ranks, function( i, val ) {
                        $('#filter-ranks').append($('<option>', {value:val.id, text:val.name}));
                    });
                }
            });
        }
        function zoneChangeFilter(zone_id){
            event.preventDefault();
            $.get('{{ url('/users/zone/field_offices') }}/'+zone_id,function(data){
                if (data.field_offices=='') {
                    $("#filter-field_offices").empty();
                    $('#filter-field_offices').append($('<option>', {value:0, text:'Please Create a Field Office in Zone'}));
                }else{
                    $("#filter-field_offices").empty();
                    $('#filter-field_offices').append($('<option>', {value:0, text:'Please Select a Field Office'}));
                    jQuery.each( data.field_offices, function( i, val ) {
                        $('#filter-field_offices').append($('<option>', {value:val.id, text:val.name}));
                    });
                }
            });
        }
        function departmentChangeFilter(department_id){
            event.preventDefault();
            $.get('{{ url('/users/department/divisions') }}/'+department_id,function(data){
                if (data.divisions=='') {
                    $("#filter-divisions").empty();
                    $('#filter-divisions').append($('<option>', {value:0, text:'Please Create a Division in Department'}));
                }else{
                    $("#filter-divisions").empty();
                    $('#filter-divisions').append($('<option>', {value:0, text:'Please Select a Division'}));
                    jQuery.each( data.divisions, function( i, val ) {
                        $('#filter-divisions').append($('<option>', {value:val.id, text:val.name}));
                    });
                }
            });
        }
