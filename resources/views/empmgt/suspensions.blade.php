          ...
          <div class="col-md-12">
            ...
            <table class="table table-stripped" id="">
              ...
              <tbody>
                ...
                {{-- <span  data-toggle="tooltip" title="View"><a href="{{ url('separation/edit_suspension?suspension_id='.$suspension->id) }}"  class="btn-sm btn btn-info   "><i class="fa fa-pencil" aria-hidden="true"></i></a></span> --}}
