  ...
  <div class="col-xl-3 col-md-6 col-xs-12 info-panel">
    ...
    <div id="holidayContent" style="display:none;">
       <ul class="list-group list-group-dividered list-group-full">
          ...
          <li class="list-group-item ">{{$holiday->title}}:{{date("F j, Y", strtotime($holiday->date))}}</li>
          @endforeach
        </ul>
    </div>
  </div>
    ...
    <div class="card card-shadow">
      <div class="card-block bg-white p-20" id="holiday">
        ...
        <span class="m-l-15 font-weight-400">LEAVE PLAN-{{date('Y')}}</span>
         <button type="button" class="btn btn-floating btn-sm btn-success pull-right" title="Add Leave Plan" data-toggle="modal" data-target="#addLeavePlanModal">
          <i class="fa fa-lg fa-plus font-weight-100 font-size-40"></i>
        </button>
        @if(!isset($leave_plans))
        <div class="content-text text-xs-center m-b-0">
          <i class="text-success icon wb-triangle-up font-size-20"></i>
          <button type="button" class="btn btn-floating btn-sm btn-success" data-toggle="modal" data-target="#leaveplan">
          <i class="fa fa-lg fa-plus font-weight-100 font-size-40"></i>
        </button>
      ...
      <table class="table">
          ...
          <tbody>
            ...
            <td>{{$leave_plan->length}}</td>
              <td><a href="#" class="deleteLeavePlan" title="Delete Leave Plan" id="{{$leave_plan->id}}"><i class="fa fa-trash text-danger"></i></a></td>
            </tr>
            @endforeach
          </tbody>
        </table>
    ...
    <div class="panel panel-info panel-line">
                <div class="panel-heading">
                  ...
                  <div class="panel-actions">
                      @if($lp->probationer_applies==1 && Auth::user()->status==0)
            ...
            <td>
              <div class="btn-group" role="group">
                ...
                <div class="dropdown-menu" aria-labelledby="exampleIconDropdown1" role="menu">
                  ...
                  <a data-leave-cancel="{{ $leave_request->id }}" style="cursor:pointer;" class="dropdown-item view-approval" ><i class="fa fa-delete" aria-hidden="true"></i>&nbsp;Cancel Leave</a>

                  <a data-toggle="modal" data-target="#editLeaveRequestModal" data-leave-edit="{{ $leave_request->id }}" style="cursor:pointer;" class="dropdown-item view-approval" ><i class="fa fa-delete" aria-hidden="true"></i>&nbsp;Edit Leave Interval</a>
                  @endif
