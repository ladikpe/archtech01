		            ...
		            <table class="table">
		            	<thead>
		            		<tr>
		            			...
		            			<th>Deduction</th>
		            			<th>Status</th>
		            			<th>Specific Salary Component Type</th>
		            			<th>For Payroll</th>
		            			<th>Action</th>
		            		</tr>
		            	</thead>
		            	<tbody>
		            		...
		            		<tr>
		            			...
		            			<td>
		            				<input type="checkbox" class="active-toggle sc-status" id="{{$latenesspolicy->id}}" {{$latenesspolicy->status == 1?'checked':''}} data-size="mini" >
								</td>
								<td>{{$latenesspolicy->specific_salary_component_type->name}}</td>
								<td>{{ucfirst($latenesspolicy->payroll)}}</td>
