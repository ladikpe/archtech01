            ...
            <div class="panel panel-info ">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{$user->name}}</td>
                     <td>{{$user->departmant?$user->department->name:''}}</td>
                      <td>{{$user->rank?($user->rank->cadre?$user->rank->cadre->name:''):''}}</td>
                      <td>{{$user->rank?$user->rank->name:''}}</td>
                       <td>{{$user->grade?$user->grade->level:''}}</td>

                       <td><a class="btn btn-info" href="{{ url('aper/get_evaluation').'?employee='.$user->id.'&mp='.$mp->id }}">Evaluate/Set Up Evaluation</a></td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
