...
@section('content')
    ...
    <div class="page" style="min-height: 1200px">
        <div class="page-aside" style="overflow: auto;">
            <!-- Contacts Sidebar -->
                    ...
                    <div data-role="content">
                        <div class="page-aside-section">
                            <div class="list-group">
                                @if (Auth::user()->role->permissions->contains('constant', 'group_access'))
                                    ...
                                    <a class="list-group-item setting-linker" href="{{ route('employeesettings') }}" title="Employee Settings">
                                ...
                                <a class="list-group-item setting-linker" href="{{ route('leavesettings') }}" title="Leave Settings">
                                    ...
                                    <a class="list-group-item setting-linker" href="{{ url('apersettings') }}" title="Leave Settings">
                                        <i class="icon fa fa-calendar-o" aria-hidden="true"></i>{{__('Aper Settings')}}
                                    </a>
                                <a class="list-group-item setting-linker" href="{{ url('notifications') }}/index" title="Notification & Alert Settings Settings">
                                ...
                                <a class="list-group-item setting-linker" href="{{ url('postings/settings')}}" title="Posting Settings">
                                    <i class="icon fa fa-wrench"
                                       aria-hidden="true"></i>{{__('Posting Settings')}}
                                </a>
                        ...
                        <i class="icon fa fa-wrench" aria-hidden="true"></i>{{__('Employee Reimbursement Settings')}}
                                ...
                                <a class="list-group-item setting-linker" href="{{ url('query')}}/settings" title="Query Settings">
                                    ...
                                    <a class="list-group-item setting-linker" href="{{ url('cadres')}}" title="Cadre Settings">
                                        <i class="icon fa fa-wrench" aria-hidden="true"></i>{{__('Cadre Settings')}}
                                    </a>
                                    <a class="list-group-item setting-linker" href="{{ url('zones')}}" title="Zone Settings">
                                        <i class="icon fa fa-wrench" aria-hidden="true"></i>{{__('Zone Settings')}}
                                    </a>
                                    ...
                                    @if(\Auth::user()->role->permissions->contains('constant','configure_vote'))
                                      <a class="list-group-item setting-linker" href="{{ url('allvotesettings')}}">
                                        <i class="icon fa fa-trophy"
                                           aria-hidden="true"></i>{{__('Vote Settings')}}
                                       </a>
                                    @endif
                            </div>
                        </div>
    ...
    <!-- End Page -->
@include('settings.votesettings.modals.voteSettingModal')
@endsection
@section('scripts')
