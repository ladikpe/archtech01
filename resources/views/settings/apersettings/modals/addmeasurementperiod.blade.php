          ...
          <div class="row row-lg col-xs-12">
            <div class="col-xs-12">
              ...
              <div class="form-group">
                ...
                <input type="text" id="" placeholder="mm-yyyy" name="from" class="form-control datepicker" autocomplete="off">
              </div>
              <div class="form-group">
                <h4 class="example-title">To</h4>

                <input type="text" id="" placeholder="mm-yyyy" name="to" class="form-control datepicker" autocomplete="off">
              </div>
