		                    ...
		                    <tbody>
                                @foreach($document_request_types as $drt)
                                    <tr>
                                        ...
                                        <td>@foreach($drt->groups as $group) {{$group->name}}, @endforeach</td>
...
<script type="text/javascript">
  ...
  function prepareEditData(document_request_type_id){
      $.get('{{ url('/document_requests/document_request_type') }}?document_request_type_id='+document_request_type_id,function(data){
          // console.log(data);
          $('#editid').val(data.id);
          ...
          $('#editworkflow_id').val(data.workflow_id);
           ...
           var grps= new Array();
            jQuery.each( data.groups, function( i, val ) {
                grps[i]=String(val.id)
                console.log(grps[i]);
          
            });
            console.log(grps);
            $("#editgroup_id").val(grps).change();
