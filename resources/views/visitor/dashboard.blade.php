    ...
    <div class="page ">
       {{-- <div class="page-header">
        ...
        <div class="page-content container-fluid">
          <div class="row">
              <div class="col-lg-12">
                  <iframe width="100%" height="1000px" src="{{env('VISITOR_URL','http://localhost:8000')}}/hcmatrix-sync?email={{ Auth::user()->email }}&url={{$url}}" frameborder="0" style="-webkit-transform:scale(1);-moz-transform-scale(1);"></iframe>
              </div>
          </div>
        </div>
    </div>
