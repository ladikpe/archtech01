...
@section('content')
    ...
    <div class="page ">
        <div class="page-header">
            <h1 class="page-title">{{__('Book Visit')}}</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('/')}}">{{__('Home')}}</a></li>
                <li class="breadcrumb-item active">{{__('Book Visit')}}</li>
            </ol>
        ...
        <div class="page-content container-fluid">
          <div class="row">
              <div class="col-lg-12">
                  <iframe width="100%" height="1000px" src="http://localhost:8000/book-visit" frameborder="0" style="-webkit-transform:scale(1);-moz-transform-scale(1);"></iframe>
              </div>
          </div>
        </div>
    </div>
