        ...
        <div class="modal-body">         
          ...
          <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <h4 class="example-title">Low Target</h4>
                                <input required type="text" name="low_target" id="editbsm_low_target" class="form-control">
                              </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <h4 class="example-title">Mid Target</h4>
                                <input required type="text" name="mid_target" id="editbsm_mid_target" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <h4 class="example-title">Upper Target</h4>
                                <input required type="text" name="upper_target" id="editbsm_upper_target" class="form-control">
                              </div>
                        </div>
                    </div>  
                    <div class="row">
