                                ...
                                <table class="table table-striped ">
                                    ...
                                    @foreach($measurement_periods as $measurement_period)
                                        <tr>
                                            ...
                                            <td><a class="btn btn-info" href="{{url('aper/get_hr_user_list?mp='.$measurement_period->id)}}">View Employees</a></td>
                                            <td><a class="btn btn-info" href="{{url('aper/get_hr_promotion_evaluated_list?mp='.$measurement_period->id)}}">View Promotion Evaluated Users</a></td>
                                            <td><a class="btn btn-info" href="{{url('aper/get_hr_promotion_not_evaluated_list?mp='.$measurement_period->id)}}">View Promotion Non-Evaluated Users</a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
