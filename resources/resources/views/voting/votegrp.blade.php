        ...
        <div class="row row-lg col-xs-12"> 
          ...
          <div class="flash-message">
            <div class="alert alert-danger" style="padding: 0px !important;">
              <h3 class="panel-title" ><span class="fa fa-line-chart"></span>Vote <b style="color: #d00;">
               {{ isset($user->name) ? $user->name : '' }} </b> for {{ base64_decode($_GET['dd']) }} </h3>
             </div>
           </div>

           <div class="col-md-3"  align="center">
            <div class="card" style=" border-right: 1px solid #c0c0c0; width: 230px;">
              <img src="{{ asset('uploads/avatar/office.jpg') }}" style="max-width: 350px;" class="card-img-top" alt="" style="width: 210px;">
              <div class="card-body">
                <h4 class="card-title"> {{ isset($user->name) ? $user->name : '' }}</h4>

            <div style="margin-top: 20px;">
              <a href="/startmenu?at={{$_GET['at']}}&ac={{$_GET['ac']}}&dd={{$_GET['dd']}}" class="tag tag-success"> See All Group </a>
            </div>
          </div>
        </div>
      </div>
