            ...
            <td>
              <div class="btn-group" role="group">
                ...
                <div class="dropdown-menu" aria-labelledby="exampleIconDropdown1" role="menu">
                  ...
                  <a style="cursor:pointer;"class="dropdown-item" id="" href="{{url('document_requests/employee_download?document_request_id='.$document_request->id)}}"><i class="fa fa-download" aria-hidden="true"></i>&nbsp;My Document</a>
                  @endif
                </div>
              </div>
            </td>
...
<script src="{{asset('global/vendor/bootstrap-table/bootstrap-table.min.js')}}"></script>
  ...
  function checkforupload(drt_id)
      {
          $.get('{{ url('/document_requests/document_request_type') }}?document_request_type_id='+drt_id,function(data){
