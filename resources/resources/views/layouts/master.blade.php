...
<!-- Fonts -->
    ...
    <style type="text/css">
        ...
        .bg-light-blue-500, .bg-cyan-600 {
            background-color: #10944a   !important;
        }
        ...
        .panel-line.panel-info .panel-heading {
            color: # 10944a  !important;
            background: transparent;
            border-top-color: #10944a   !important;
        }
    ...
    <div class="navbar-container container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
            ...
            <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                <li class="nav-item hidden-float" style="margin-top:15px;margin-right:10px;color:#ffffff;" >
                         {{Auth::user()->name}} ({{Auth::user()->role?Auth::user()->role->name:''}}) 
                    <img
